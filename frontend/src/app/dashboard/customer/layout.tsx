...
const navItems = [
  ...
  { href: "/dashboard/customer/notifications", label: "Notifications", icon: "notifications" },
  ...
  return (
    <ProtectedPage allowedRoles={["customer"]}>
      <div className="flex min-h-screen" style={{ backgroundColor: "#F9F5F0", fontFamily: "Manrope, sans-serif" }}>
        <nav
          className="fixed left-0 top-0 hidden h-full w-64 flex-col border-r px-4 py-8 md:flex z-40"
        ...
        >
          ...
          <div className="mt-auto flex flex-col gap-3">
            <Link
              href="/catalog"
              className="w-full rounded-lg px-4 py-3 text-center text-[13px] font-semibold uppercase tracking-wider text-white shadow-sm transition-all duration-200 hover:opacity-90"
              style={{ backgroundColor: "#8B0000" }}
            >
              Thuê ngay
            </Link>
        ...
        <div className="flex flex-1 flex-col md:ml-64">
          ...
          >
            ...
            <div className="flex items-center gap-3" style={{ color: "#8B0000" }}>
              <Link href="/dashboard/customer/notifications" className="hover:opacity-70" aria-label="Thông báo">
